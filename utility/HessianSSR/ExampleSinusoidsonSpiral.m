% This code shows a toy demo of regression based on Hessian energy. There are 3 parameters to be tuned for regression:
...
%%% generate data
    ...
    LLoc = [10,100,200,300,400,500,600,700,800];
    Var = LLoc/100;
    for i=1:length(LLoc);
        Labels.LFlag(LLoc(i)) = 1;
        Labels.y(LLoc(i)) = sin(2*Var(i));
    end
